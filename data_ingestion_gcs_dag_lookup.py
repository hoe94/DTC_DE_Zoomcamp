...
OUTPUT_FILE_TEMPLATE = path_to_local_home + '/lookup_output.csv'
parquet_file = 'lookup_output.csv'.replace('.csv', '.parquet')
...
with DAG(
    dag_id="data_ingestion_gcs_dag_lookup",
    ...
    download_dataset_task = BashOperator(
        ...
        bash_command=f"curl -sSLf {DATASET_URL} > {OUTPUT_FILE_TEMPLATE}"
    )
